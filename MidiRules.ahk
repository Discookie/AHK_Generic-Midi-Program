...
macros := {}
macros9 := { 0x80: ["{Left}", 16],    0x81: ["{Right}", 16],        0x82: ["{Up}", 16],          0x83: ["{Down}", 16],               0x84: ["^c^l", 34], 0x85: ["^c^n", 17],           0x86: ["^c^ ", 17],          0x87: ["", 3] }
macros1 := { 0x00: ["Bool ", 34],     0x01: ["true ", 16],          0x02: ["false ", 16],        0x03: ["if then else ", 1],         0x04: [],           0x05: ["{U+22A5} ", 34],      0x06: ["exfalso ", 1],       0x07: ["Set ", 17],                           0x08: ["", 16] }
macros2 := { 0x10: ["{U+2115} ", 34], 0x11: ["zero ", 16],          0x12: ["suc ", 16],          0x13: ["primrec ", 1],              0x14: [],           0x15: ["{U+22A4} ", 34],      0x16: ["tt ", 16],           0x17: ["{U+2115}Ind ", 1],                           0x18: []       }
macros3 := { 0x20: ["{U+00D7} ", 34], 0x21: [", ", 16],             0x22: ["proj{U+2081} ", 1],  0x23: ["proj{U+2082} ", 1],         0x24: [],           0x25: ["{Enter}", 16],        0x26: ["{Backspace}", 18],   0x27: [],                           0x28: []       }
macros4 := { 0x30: ["{U+228E} ", 34], 0x31: ["inj{U+2081} ", 16],   0x32: ["inj{U+2082} ", 16],  0x33: ["case ", 1],                 0x34: [],           0x35: ["(", 17],              0x36: ["{Backspace}) ", 17], 0x37: ["? ", 32],                    0x38: []       }
...
macros7 := { 0x60: ["a ", 17],        0x61: ["b ", 17],             0x62: ["c ", 17],            0x63: ["_ ", 1],                    0x64: ["f ", 16],   0x65: ["g ", 16],             0x66: ["h ", 16],            0x67: ["{Left}{U+2081}{Right}", 1], 0x68: []       }
macros8 := { 0x70: ["t ", 16],        0x71: ["u ", 16],             0x72: ["v ", 16],            0x73: ["{Left}'{Right}", 1],        0x74: ["x ", 17],   0x75: ["y ", 17],             0x76: ["z ", 17],            0x77: ["{Left}{U+2082}{Right}", 1], 0x78: []       }

; Used when MOD1 is active
macros_mod1 := { 0x80: ["^{Left}", 16], 0x81: ["^{Right}", 16], 0x82: ["{PgUp}", 16], 0x83: ["{PgDn}", 16],     0x26: ["^{Backspace}", 18],     0x37: ["_ ", 32], 0x46: ["{U+21A6}  ", 18],     0x60: ["A ", 17], 0x61: ["B ", 17], 0x62: ["C ", 17],     0x64: ["F ", 16], 0x65: ["G ", 16], 0x66: ["H ", 16],     0x74: ["X ", 17], 0x75: ["Y ", 17], 0x76: ["Z ", 17],     0x41: ["{U+2245} ", 49],     0x84: ["^c^a", 17], 0x85: ["^c^.", 17], 0x86: ["^n^n^c^.", 17] }
